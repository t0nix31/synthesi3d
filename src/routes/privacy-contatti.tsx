      ...
      <section className="border-b border-border/60 py-24 md:py-32">
        <div className="mx-auto max-w-4xl px-6 lg:px-10">
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            ...
            agli allegati tecnici, a Cloudflare R2 e al servizio di invio email.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-20 lg:px-10">
        <div className="space-y-12 text-muted-foreground">
          <Block title="1. Titolare del trattamento">
            ...
            <p className="mt-3">Sede: Sperone (AV), Italia.</p>
          </Block>
          ...
          <Block title="2. Dati raccolti tramite il modulo">
            ...
            <p className="mt-3">
              ...
              riferimento, ad esempio immagini, PDF, file STL, STEP, STP, OBJ, ZIP o
              altri documenti utili alla valutazione del progetto.
            </p>
          </Block>
          ...
          <Block title="4. Base giuridica">
            ...
            <p className="mt-3">
              ...
              sicurezza del sito, la prevenzione di abusi e la conservazione ordinata
              delle richieste ricevute, il trattamento può basarsi anche sul legittimo
          ...
          <Block title="7. Conservazione degli allegati">
            <p>
              Gli allegati caricati tramite il modulo contatti vengono conservati per
              un massimo di 30 giorni e poi eliminati automaticamente dal bucket R2.
            </p>
            ...
            <p className="mt-3">
              ...
              amministrativi o legali applicabili.
            </p>
          </Block>
          ...
          <Block title="9. Destinatari dei dati">
            <p>
            ...
            <p className="mt-3">
              ...
              sopra, nei limiti necessari alla fornitura dei rispettivi servizi.
            </p>
          </Block>

          <Block title="10. Trasferimenti extra UE">
            <p>
              Alcuni fornitori tecnici utilizzati per l’erogazione del sito e dei
              servizi collegati possono trattare dati anche al di fuori dello Spazio
              Economico Europeo, secondo le rispettive condizioni contrattuali,
              garanzie e informative privacy.
            </p>
          ...
          <Block title="11. Misure di sicurezza">
            <p>
          ...
          <Block title="12. Diritti dell’interessato">
            <p>
          ...
          <Block title="13. Privacy Policy e Cookie Policy complete">
            <p>
          ...
          <Block title="14. Ultimo aggiornamento">
            <p>Questa informativa è stata aggiornata il 12 maggio 2026.</p>
          </Block>
